								...
								<table>
									<tr>
										<td>
											...
											<p>En av våra partners kommer att kontakta dig inom 24 timmar med ett prisförslag. Renthia har förhandlat fram bästa priset för kunder inom dem olika segmenten.</p>
											<br>
											<p>Ditt meddelande till oss:</p>
											<div class='main'>
												<p><strong>Service: </strong><br><?php echo $service; ?></p>
