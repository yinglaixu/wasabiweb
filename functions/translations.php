...
icl_register_string('Theme-mypages', 'My property', '', false, 'sv');
icl_register_string('Theme-mypages', 'My documents', '', false, 'sv');
icl_register_string('Theme-mypages', 'Contract', '', false, 'sv');
icl_register_string('Theme-mypages', 'Inventory list', '', false, 'sv');
icl_register_string('Theme-mypages', 'Inspection list', '', false, 'sv');


// my contract form
icl_register_string('Theme-mycontract', 'Personal number', 'Personnumber', false, 'sv');
icl_register_string('Theme-mycontract', 'Bank name', 'Bank namn', false, 'sv');
...
icl_register_string('Theme-mycontract', 'Rental period 3', 'Hyresperioden 3', false, 'sv');
icl_register_string('Theme-mycontract', 'From date to further notice', 'Från datum vidare', false, 'sv');
icl_register_string('Theme-mycontract', 'From date', 'Från datum', false, 'sv');
icl_register_string('Theme-mycontract', 'To date', 'Hittills', false, 'sv');
...
icl_register_string('Theme-mycontract', 'Heat', 'Hetta', false, 'sv');
...
icl_register_string('Theme-mycontract', 'Storage', 'Lagring', false, 'sv');
...
icl_register_string('Theme-mycontract', 'Garbage handling', 'Sopor hantering', false, 'sv');
icl_register_string('Theme-mycontract', 'Community fee', 'Gemenskapsavgift', false, 'sv');
icl_register_string('Theme-mycontract', 'Operation fee', 'Drift avgift', false, 'sv');
icl_register_string('Theme-mycontract', 'Electricity fee', 'El avgift', false, 'sv');
...
icl_register_string('Theme-mycontract', 'Keep pets', 'Håll husdjur', false, 'sv');
icl_register_string('Theme-mycontract', 'Is allowed', 'Tillåten', false, 'sv');
...
icl_register_string('Theme-mycontract', 'Extra notes', 'Extranoter', false, 'sv');
// my contract content
icl_register_string('Theme-mycontract', 'The lease is entered', 'Hyresavtalet ingås', false, 'sv');
icl_register_string('Theme-mycontract', 'between', 'mellan', false, 'sv');
icl_register_string('Theme-mycontract', 'Landlord and', 'Hyresvärd och', false, 'sv');
icl_register_string('Theme-mycontract', 'Tenant', 'Hyresgäst', false, 'sv');
icl_register_string('Theme-mycontract', 'The landlord hereby leases', 'Hyresvärden hyr härmed', false, 'sv');
icl_register_string('Theme-mycontract', 'room', 'rum', false, 'sv');
icl_register_string('Theme-mycontract', 'and', 'och', false, 'sv');
...
icl_register_string('Theme-mycontract', 'Invoice received mail', 'Faktura fick post', false, 'sv');
...
icl_register_string('Theme-mycontract', 'The rental will include', 'Hyran kommer att omfatta', false, 'sv');
icl_register_string('Theme-mycontract', 'If', 'Om', false, 'sv');
icl_register_string('Theme-mycontract', 'is included, the cost of', 'ingår, kostnaden av', false, 'sv');
icl_register_string('Theme-mycontract', 'will be a maximum of', 'kommer att vara högst', false, 'sv');
icl_register_string('Theme-mycontract', 'month', 'månad', false, 'sv');
icl_register_string('Theme-mycontract', 'Excess amounts will be', 'Överskjutande belopp kommer att vara', false, 'sv');
...
icl_register_string('Theme-mycontract', 'The keys is handed', 'Tangenterna är handed', false, 'sv');
...
icl_register_string('Theme-inventory_inspection', 'Entrance', 'Ingång', false, 'sv');
icl_register_string('Theme-inventory_inspection', 'Others', 'Andra', false, 'sv');
icl_register_string('Theme-inventory_inspection', 'Add line', 'Lägga linje', false, 'sv');
icl_register_string('Theme-inventory_inspection', 'Name', 'Namn', false, 'sv');
icl_register_string('Theme-inventory_inspection', 'Count', 'Räkna', false, 'sv');
